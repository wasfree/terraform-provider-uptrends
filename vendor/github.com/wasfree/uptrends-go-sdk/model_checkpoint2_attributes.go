...
// Checkpoint2Attributes Object attributes 
type Checkpoint2Attributes struct {
...
func (o Checkpoint2Attributes) MarshalJSON() ([]byte, error) {
...
type NullableCheckpoint2Attributes struct {
	value *Checkpoint2Attributes
	isSet bool
}

func (v NullableCheckpoint2Attributes) Get() *Checkpoint2Attributes {
	return v.value
}

func (v *NullableCheckpoint2Attributes) Set(val *Checkpoint2Attributes) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckpoint2Attributes) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckpoint2Attributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckpoint2Attributes(val *Checkpoint2Attributes) *NullableCheckpoint2Attributes {
	return &NullableCheckpoint2Attributes{value: val, isSet: true}
}

func (v NullableCheckpoint2Attributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckpoint2Attributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
