...
// CheckpoinServerResponseData The resposne data/monitor checks
type CheckpoinServerResponseData struct {
...
func NewCheckpoinServerResponseData(id int32) *CheckpoinServerResponseData {
	this := CheckpoinServerResponseData{}
	this.Id = id
	return &this
}
...
func (o CheckpoinServerResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCheckpoinServerResponseData struct {
	value *CheckpoinServerResponseData
	isSet bool
}

func (v NullableCheckpoinServerResponseData) Get() *CheckpoinServerResponseData {
	return v.value
}

func (v *NullableCheckpoinServerResponseData) Set(val *CheckpoinServerResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckpoinServerResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckpoinServerResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckpoinServerResponseData(val *CheckpoinServerResponseData) *NullableCheckpoinServerResponseData {
	return &NullableCheckpoinServerResponseData{value: val, isSet: true}
}

func (v NullableCheckpoinServerResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckpoinServerResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
