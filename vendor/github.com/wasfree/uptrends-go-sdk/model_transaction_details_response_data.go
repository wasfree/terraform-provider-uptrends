...
// TransactionDetailsResponseData The resposne data/monitor checks
type TransactionDetailsResponseData struct {
	Attributes *TransactionCheckDetailsAttributes `json:"Attributes,omitempty"`
	// Identifier 
	Id int64 `json:"Id"`
	// Object type
...
func NewTransactionDetailsResponseData(id int64) *TransactionDetailsResponseData {
	this := TransactionDetailsResponseData{}
	this.Id = id
	return &this
}
...
func (o *TransactionDetailsResponseData) GetAttributes() TransactionCheckDetailsAttributes {
	if o == nil || isNil(o.Attributes) {
		var ret TransactionCheckDetailsAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given TransactionCheckDetailsAttributes and assigns it to the Attributes field.
...
func (o TransactionDetailsResponseData) MarshalJSON() ([]byte, error) {
...
type NullableTransactionDetailsResponseData struct {
	value *TransactionDetailsResponseData
	isSet bool
}

func (v NullableTransactionDetailsResponseData) Get() *TransactionDetailsResponseData {
	return v.value
}

func (v *NullableTransactionDetailsResponseData) Set(val *TransactionDetailsResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionDetailsResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionDetailsResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionDetailsResponseData(val *TransactionDetailsResponseData) *NullableTransactionDetailsResponseData {
	return &NullableTransactionDetailsResponseData{value: val, isSet: true}
}

func (v NullableTransactionDetailsResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionDetailsResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
