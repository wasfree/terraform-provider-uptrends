...
// ListStringResponse struct for ListStringResponse
...
func (o ListStringResponse) MarshalJSON() ([]byte, error) {
...
type NullableListStringResponse struct {
	value *ListStringResponse
	isSet bool
}

func (v NullableListStringResponse) Get() *ListStringResponse {
	return v.value
}

func (v *NullableListStringResponse) Set(val *ListStringResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListStringResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListStringResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListStringResponse(val *ListStringResponse) *NullableListStringResponse {
	return &NullableListStringResponse{value: val, isSet: true}
}

func (v NullableListStringResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListStringResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
