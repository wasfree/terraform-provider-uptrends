...
// HttpCheckDetails struct for HttpCheckDetails
...
func (o HttpCheckDetails) MarshalJSON() ([]byte, error) {
...
type NullableHttpCheckDetails struct {
	value *HttpCheckDetails
	isSet bool
}

func (v NullableHttpCheckDetails) Get() *HttpCheckDetails {
	return v.value
}

func (v *NullableHttpCheckDetails) Set(val *HttpCheckDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpCheckDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpCheckDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpCheckDetails(val *HttpCheckDetails) *NullableHttpCheckDetails {
	return &NullableHttpCheckDetails{value: val, isSet: true}
}

func (v NullableHttpCheckDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpCheckDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
