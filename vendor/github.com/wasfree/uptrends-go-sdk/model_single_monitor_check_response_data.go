...
// SingleMonitorCheckResponseData The resposne data/monitor checks
type SingleMonitorCheckResponseData struct {
...
func (o *SingleMonitorCheckResponseData) GetAttributes() MonitorCheckAttributes {
	if o == nil || isNil(o.Attributes) {
		var ret MonitorCheckAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given MonitorCheckAttributes and assigns it to the Attributes field.
...
func (o SingleMonitorCheckResponseData) MarshalJSON() ([]byte, error) {
...
type NullableSingleMonitorCheckResponseData struct {
	value *SingleMonitorCheckResponseData
	isSet bool
}

func (v NullableSingleMonitorCheckResponseData) Get() *SingleMonitorCheckResponseData {
	return v.value
}

func (v *NullableSingleMonitorCheckResponseData) Set(val *SingleMonitorCheckResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleMonitorCheckResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleMonitorCheckResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleMonitorCheckResponseData(val *SingleMonitorCheckResponseData) *NullableSingleMonitorCheckResponseData {
	return &NullableSingleMonitorCheckResponseData{value: val, isSet: true}
}

func (v NullableSingleMonitorCheckResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleMonitorCheckResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
