...
func (o MonitorCheck) MarshalJSON() ([]byte, error) {
...
type NullableMonitorCheck struct {
	value *MonitorCheck
	isSet bool
}

func (v NullableMonitorCheck) Get() *MonitorCheck {
	return v.value
}

func (v *NullableMonitorCheck) Set(val *MonitorCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitorCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitorCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitorCheck(val *MonitorCheck) *NullableMonitorCheck {
	return &NullableMonitorCheck{value: val, isSet: true}
}

func (v NullableMonitorCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitorCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
