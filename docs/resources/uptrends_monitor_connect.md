...
page_title: "uptrends_monitor_connect Resource - terraform-provider-uptends"
subcategory: ""
description: |-
  Manages an Uptrends Connect Monitor.
---

# uptrends_monitor_connect (Resource)
...
- **port** (Number) The TCP Port for the Monitor.
